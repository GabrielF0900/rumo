...
export const comoLidarComProcrastinacaoNosEstudosGuide = {
  slug: "como-lidar-com-procrastinacao-nos-estudos",
  category: "estudar",
  title: "Como lidar com procrastinação nos estudos",
  summary: "Reduzir barreiras de início, usar tarefas mínimas e identificar gatilhos de adiamento.",
  description: "Reduzir barreiras de início, usar tarefas mínimas e identificar gatilhos de adiamento. Este guia deve ser lido como orientação educativa e prática, não como uma fórmula única. A proposta da Rumo é ajudar o estudante a compreender o tema, tomar decisões mais informadas e transformar a leitura em uma próxima ação concreta.",
  readTime: 8,
  tags: [
    "lidar",
    "com",
  ...
  learningObjectives: [
    "Procrastinação não é simplesmente 'preguiça'; a literatura a relaciona à autorregulação, ao contexto, à emoção e às características da tarefa.",
    "Reduza a tarefa até um primeiro passo que possa começar em poucos minutos.",
    "Remova distrações previsíveis antes de depender de autocontrole no meio da tarefa.",
    "Use intenção de implementação: 'quando X acontecer, começarei Y por Z minutos'.",
    "Observe emoções associadas ao adiamento, como ansiedade, tédio ou medo de errar.",
    "Se o adiamento for persistente e vier acompanhado de sofrimento importante, converse com um adulto de confiança ou serviço de apoio.",
  ...
  sections: [
    ...
    {
      "title": "Procrastinação não é simplesmente 'preguiça'; a literatura a relaciona à…",
      "paragraphs": [
        "Procrastinação não é simplesmente 'preguiça'; a literatura a relaciona à autorregulação, ao contexto, à emoção e às características da tarefa."
      ],
      "id": "procrastinacao-nao-e-simplesmente-preguica-a-literatura-a-relaciona-a"
    },
    {
      "title": "Reduza a tarefa até um primeiro passo que possa começar em poucos minutos",
      "paragraphs": [
        "Reduza a tarefa até um primeiro passo que possa começar em poucos minutos."
      ],
      "id": "reduza-a-tarefa-ate-um-primeiro-passo-que-possa-comecar-em-poucos-minutos"
    },
    {
      "title": "Remova distrações previsíveis antes de depender de autocontrole no meio d…",
      "paragraphs": [
        "Remova distrações previsíveis antes de depender de autocontrole no meio da tarefa."
      ],
      "id": "remova-distracoes-previsiveis-antes-de-depender-de-autocontrole-no-meio-d"
    },
    {
      "title": "Use intenção de implementação",
      "paragraphs": [
        "Use intenção de implementação: 'quando X acontecer, começarei Y por Z minutos'."
      ],
      "id": "use-intencao-de-implementacao"
    },
    {
      "title": "Observe emoções associadas ao adiamento, como ansiedade, tédio ou medo de…",
      "paragraphs": [
        "Observe emoções associadas ao adiamento, como ansiedade, tédio ou medo de errar."
      ],
      "id": "observe-emocoes-associadas-ao-adiamento-como-ansiedade-tedio-ou-medo-de"
    },
    {
      "title": "Se o adiamento for persistente e vier acompanhado de sofrimento important…",
      "paragraphs": [
        "Se o adiamento for persistente e vier acompanhado de sofrimento importante, converse com um adulto de confiança ou serviço de apoio."
      ],
      "id": "se-o-adiamento-for-persistente-e-vier-acompanhado-de-sofrimento-important"
    },
    {
      "title": "Cenários e exemplos desenvolvidos",
      "paragraphs": [],
      "examples": [
        "Cenário escolar: um estudante tem duas provas e um trabalho na mesma semana. Em vez de estudar tudo de forma genérica, aplica o princípio de como-lidar-com-procrastinacao-nos-estudos para transformar a situação em decisões concretas.",
    ...
    },
    {
      ...
      "paragraphs": [
        "Missão: aplique o princípio de Como lidar com procrastinação nos estudos a uma situação real desta semana."
      ],
    ...
    },
    {
      ...
      "paragraphs": [
        "Escolha uma situação real relacionada a Como lidar com procrastinação nos estudos. Escreva como agiria espontaneamente. Depois refaça a decisão usando um critério do guia e defina uma evidência que mostraria se a nova abordagem ajudou."
      ],
      "examples": [
  ...
  relatedGuides: [
    "como-estudar-matematica-sem-decorar-tudo",
    "como-melhorar-em-interpretacao-de-texto"
  ],
