...
export const comoMontarUmaRotinaDeEstudosRealistaGuide = {
  slug: "como-montar-uma-rotina-de-estudos-realista",
  category: "estudar",
  title: "Como montar uma rotina de estudos realista",
  summary: "Planejar uma semana compatível com escola, descanso, deslocamento, tarefas e imprevistos.",
  description: "Planejar uma semana compatível com escola, descanso, deslocamento, tarefas e imprevistos. Este guia deve ser lido como orientação educativa e prática, não como uma fórmula única. A proposta da Rumo é ajudar o estudante a compreender o tema, tomar decisões mais informadas e transformar a leitura em uma próxima ação concreta.",
  readTime: 8,
  tags: [
    "montar",
    "rotina",
  ...
  learningObjectives: [
    "Faça um inventário realista de compromissos fixos, deslocamentos, sono, alimentação e tempo livre antes de encaixar blocos de estudo.",
    "Converta matérias em tarefas observáveis: 'ler 10 páginas', 'resolver 8 questões', 'revisar 15 flashcards' é mais executável que 'estudar química'.",
    "Planeje margem para imprevistos. Uma agenda sem espaço de recuperação tende a quebrar após o primeiro atraso.",
    "Use revisão semanal: o que foi concluído, o que acumulou, por quê e o que deve ser renegociado.",
    "Priorize por prazo, dificuldade, peso acadêmico e dependências entre conteúdos.",
    "Prefira consistência sustentável a maratonas ocasionais.",
  ...
  sections: [
    ...
    {
      "title": "Faça um inventário realista de compromissos fixos, deslocamentos, sono, a…",
      "paragraphs": [
        "Faça um inventário realista de compromissos fixos, deslocamentos, sono, alimentação e tempo livre antes de encaixar blocos de estudo."
      ],
      "id": "faca-um-inventario-realista-de-compromissos-fixos-deslocamentos-sono-a"
    },
    {
      "title": "Converta matérias em tarefas observáveis",
      "paragraphs": [
        "Converta matérias em tarefas observáveis: 'ler 10 páginas', 'resolver 8 questões', 'revisar 15 flashcards' é mais executável que 'estudar química'."
      ],
      "id": "converta-materias-em-tarefas-observaveis"
    },
    {
      "title": "Planeje margem para imprevistos",
      "paragraphs": [
        "Planeje margem para imprevistos. Uma agenda sem espaço de recuperação tende a quebrar após o primeiro atraso."
      ],
      "id": "planeje-margem-para-imprevistos"
    },
    {
      "title": "Use revisão semanal",
      "paragraphs": [
        "Use revisão semanal: o que foi concluído, o que acumulou, por quê e o que deve ser renegociado."
      ],
      "id": "use-revisao-semanal"
    },
    {
      "title": "Priorize por prazo, dificuldade, peso acadêmico e dependências entre cont…",
      "paragraphs": [
        "Priorize por prazo, dificuldade, peso acadêmico e dependências entre conteúdos."
      ],
      "id": "priorize-por-prazo-dificuldade-peso-academico-e-dependencias-entre-cont"
    },
    {
      "title": "Prefira consistência sustentável a maratonas ocasionais",
      "paragraphs": [
        "Prefira consistência sustentável a maratonas ocasionais."
      ],
      "id": "prefira-consistencia-sustentavel-a-maratonas-ocasionais"
    },
    {
      "title": "Cenários e exemplos desenvolvidos",
      "paragraphs": [],
      "examples": [
        "Cenário escolar: um estudante tem duas provas e um trabalho na mesma semana. Em vez de estudar tudo de forma genérica, aplica o princípio de como-montar-uma-rotina-de-estudos-realista para transformar a situação em decisões concretas.",
    ...
    },
    {
      ...
      "paragraphs": [
        "Missão: aplique o princípio de Como montar uma rotina de estudos realista a uma situação real desta semana."
      ],
    ...
    },
    {
      ...
      "paragraphs": [
        "Escolha uma situação real relacionada a Como montar uma rotina de estudos realista. Escreva como agiria espontaneamente. Depois refaça a decisão usando um critério do guia e defina uma evidência que mostraria se a nova abordagem ajudou."
      ],
      "examples": [
