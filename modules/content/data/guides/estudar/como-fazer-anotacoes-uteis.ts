...
export const comoFazerAnotacoesUteisGuide = {
  slug: "como-fazer-anotacoes-uteis",
  category: "estudar",
  title: "Como fazer anotações úteis",
  summary: "Diferenciar copiar de registrar ideias-chave, dúvidas, exemplos e relações entre conceitos.",
  description: "Diferenciar copiar de registrar ideias-chave, dúvidas, exemplos e relações entre conceitos. Este guia deve ser lido como orientação educativa e prática, não como uma fórmula única. A proposta da Rumo é ajudar o estudante a compreender o tema, tomar decisões mais informadas e transformar a leitura em uma próxima ação concreta.",
  readTime: 8,
  tags: [
    "fazer",
    "anotacoes",
  ...
  learningObjectives: [
    "Anotação é ferramenta de pensamento e referência; não precisa reproduzir cada frase da aula ou do texto.",
    "Registre conceitos centrais, relações, exemplos, dúvidas e pontos que exigem checagem.",
    "Diferencie citação literal de paráfrase para preservar autoria e facilitar referências.",
    "Após a aula, faça uma revisão curta e transforme algumas notas em perguntas.",
    "Use estrutura visual apenas quando ela ajuda a recuperar relações entre ideias.",
    "Evite gastar mais energia decorando a página do que processando o conteúdo.",
  ...
  sections: [
    ...
    {
      "title": "Anotação é ferramenta de pensamento e referência; não precisa reproduzir…",
      "paragraphs": [
        "Anotação é ferramenta de pensamento e referência; não precisa reproduzir cada frase da aula ou do texto."
      ],
      "id": "anotacao-e-ferramenta-de-pensamento-e-referencia-nao-precisa-reproduzir"
    },
    {
      "title": "Registre conceitos centrais, relações, exemplos, dúvidas e pontos que exi…",
      "paragraphs": [
        "Registre conceitos centrais, relações, exemplos, dúvidas e pontos que exigem checagem."
      ],
      "id": "registre-conceitos-centrais-relacoes-exemplos-duvidas-e-pontos-que-exi"
    },
    {
      "title": "Diferencie citação literal de paráfrase para preservar autoria e facilita…",
      "paragraphs": [
        "Diferencie citação literal de paráfrase para preservar autoria e facilitar referências."
      ],
      "id": "diferencie-citacao-literal-de-parafrase-para-preservar-autoria-e-facilita"
    },
    {
      "title": "Após a aula, faça uma revisão curta e transforme algumas notas em perguntas",
      "paragraphs": [
        "Após a aula, faça uma revisão curta e transforme algumas notas em perguntas."
      ],
      "id": "apos-a-aula-faca-uma-revisao-curta-e-transforme-algumas-notas-em-perguntas"
    },
    {
      "title": "Use estrutura visual apenas quando ela ajuda a recuperar relações entre i…",
      "paragraphs": [
        "Use estrutura visual apenas quando ela ajuda a recuperar relações entre ideias."
      ],
      "id": "use-estrutura-visual-apenas-quando-ela-ajuda-a-recuperar-relacoes-entre-i"
    },
    {
      "title": "Evite gastar mais energia decorando a página do que processando o conteúdo",
      "paragraphs": [
        "Evite gastar mais energia decorando a página do que processando o conteúdo."
      ],
      "id": "evite-gastar-mais-energia-decorando-a-pagina-do-que-processando-o-conteudo"
    },
    {
      "title": "Cenários e exemplos desenvolvidos",
      "paragraphs": [],
      "examples": [
        "Cenário escolar: um estudante tem duas provas e um trabalho na mesma semana. Em vez de estudar tudo de forma genérica, aplica o princípio de como-fazer-anotacoes-uteis para transformar a situação em decisões concretas.",
    ...
    },
    {
      ...
      "paragraphs": [
        "Missão: aplique o princípio de Como fazer anotações úteis a uma situação real desta semana."
      ],
    ...
    },
    {
      ...
      "paragraphs": [
        "Escolha uma situação real relacionada a Como fazer anotações úteis. Escreva como agiria espontaneamente. Depois refaça a decisão usando um critério do guia e defina uma evidência que mostraria se a nova abordagem ajudou."
      ],
      "examples": [
  ...
  relatedGuides: [
    ...
    "como-usar-questoes-e-simulados-para-aprender"
  ],
