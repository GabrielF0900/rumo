...
export const comoEstudarQuandoVoceEstaCansadoGuide = {
  slug: "como-estudar-quando-voce-esta-cansado",
  category: "estudar",
  title: "Como estudar quando você está cansado",
  summary: "Adaptar a carga, escolher tarefas mais leves e reconhecer quando descanso é mais produtivo que insistir.",
  description: "Adaptar a carga, escolher tarefas mais leves e reconhecer quando descanso é mais produtivo que insistir. Este guia deve ser lido como orientação educativa e prática, não como uma fórmula única. A proposta da Rumo é ajudar o estudante a compreender o tema, tomar decisões mais informadas e transformar a leitura em uma próxima ação concreta.",
  readTime: 8,
  tags: [
    "estudar",
    "quando",
  ...
  learningObjectives: [
    "Cansaço muda a qualidade da atenção; ajuste o tipo de tarefa em vez de exigir o mesmo desempenho de um período de maior energia.",
    "Em dias difíceis, escolha manutenção: organizar materiais, revisar poucos cartões, corrigir questões já feitas ou preparar o próximo estudo.",
    "Evite transformar privação de sono em estratégia recorrente de estudo.",
    "Se o cansaço é persistente e afeta rotina, escola ou funcionamento diário, procure apoio de um adulto de confiança e dos serviços adequados.",
    "Use metas mínimas para preservar continuidade sem transformar disciplina em punição.",
    "Se precisar parar, registre o próximo passo para diminuir o custo de retomar.",
  ...
  sections: [
    ...
    {
      "title": "Cansaço muda a qualidade da atenção; ajuste o tipo de tarefa em vez de ex…",
      "paragraphs": [
        "Cansaço muda a qualidade da atenção; ajuste o tipo de tarefa em vez de exigir o mesmo desempenho de um período de maior energia."
      ],
      "id": "cansaco-muda-a-qualidade-da-atencao-ajuste-o-tipo-de-tarefa-em-vez-de-ex"
    },
    {
      "title": "Em dias difíceis, escolha manutenção",
      "paragraphs": [
        "Em dias difíceis, escolha manutenção: organizar materiais, revisar poucos cartões, corrigir questões já feitas ou preparar o próximo estudo."
      ],
      "id": "em-dias-dificeis-escolha-manutencao"
    },
    {
      "title": "Evite transformar privação de sono em estratégia recorrente de estudo",
      "paragraphs": [
        "Evite transformar privação de sono em estratégia recorrente de estudo."
      ],
      "id": "evite-transformar-privacao-de-sono-em-estrategia-recorrente-de-estudo"
    },
    {
      "title": "Se o cansaço é persistente e afeta rotina, escola ou funcionamento diário…",
      "paragraphs": [
        "Se o cansaço é persistente e afeta rotina, escola ou funcionamento diário, procure apoio de um adulto de confiança e dos serviços adequados."
      ],
      "id": "se-o-cansaco-e-persistente-e-afeta-rotina-escola-ou-funcionamento-diario"
    },
    {
      "title": "Use metas mínimas para preservar continuidade sem transformar disciplina…",
      "paragraphs": [
        "Use metas mínimas para preservar continuidade sem transformar disciplina em punição."
      ],
      "id": "use-metas-minimas-para-preservar-continuidade-sem-transformar-disciplina"
    },
    {
      "title": "Se precisar parar, registre o próximo passo para diminuir o custo de reto…",
      "paragraphs": [
        "Se precisar parar, registre o próximo passo para diminuir o custo de retomar."
      ],
      "id": "se-precisar-parar-registre-o-proximo-passo-para-diminuir-o-custo-de-reto"
    },
    {
      "title": "Cenários e exemplos desenvolvidos",
      "paragraphs": [],
      "examples": [
        "Cenário escolar: um estudante tem duas provas e um trabalho na mesma semana. Em vez de estudar tudo de forma genérica, aplica o princípio de como-estudar-quando-voce-esta-cansado para transformar a situação em decisões concretas.",
    ...
    },
    {
      ...
      "paragraphs": [
        "Missão: aplique o princípio de Como estudar quando você está cansado a uma situação real desta semana."
      ],
    ...
    },
    {
      ...
      "paragraphs": [
        "Escolha uma situação real relacionada a Como estudar quando você está cansado. Escreva como agiria espontaneamente. Depois refaça a decisão usando um critério do guia e defina uma evidência que mostraria se a nova abordagem ajudou."
      ],
      "examples": [
        "Menor passo útil. Abordagem fraca: A pessoa espera motivação perfeita. Aplicação melhor: Define uma ação de 10 minutos com critério de conclusão. Por que é pedagógico: Reduz atrito de início.",
        "Ambiente. Abordagem fraca: Notificações disputam atenção. Aplicação melhor: Silencia alertas, deixa só material necessário e usa lista de estacionamento. Por que é pedagógico: Mostra que foco também é desenho de ambiente.",
        "Ajuste de carga. Abordagem fraca: Mantém tarefa pesada mesmo exausto. Aplicação melhor: Troca por correção, organização ou revisão curta e registra onde retomar. Por que é pedagógico: Evita transformar disciplina em punição."
      ],
      "tips": [
  ...
  relatedGuides: [
    ...
    "resumos-e-mapas-mentais-quando-ajudam-e-quando-atrapalham"
  ],
