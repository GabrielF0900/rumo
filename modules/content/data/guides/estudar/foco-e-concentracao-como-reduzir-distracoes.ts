...
export const focoEConcentracaoComoReduzirDistracoesGuide = {
  slug: "foco-e-concentracao-como-reduzir-distracoes",
  category: "estudar",
  title: "Foco e concentração: como reduzir distrações",
  summary: "Organizar ambiente, celular, notificações, tarefas e intervalos para facilitar períodos de atenção.",
  description: "Organizar ambiente, celular, notificações, tarefas e intervalos para facilitar períodos de atenção. Este guia deve ser lido como orientação educativa e prática, não como uma fórmula única. A proposta da Rumo é ajudar o estudante a compreender o tema, tomar decisões mais informadas e transformar a leitura em uma próxima ação concreta.",
  readTime: 8,
  tags: [
    "foco",
    "concentracao",
  ...
  learningObjectives: [
    "Reduza atrito para começar: material aberto, tarefa definida e primeiro passo pequeno.",
    "Afaste notificações e estímulos que disputam atenção durante blocos de estudo.",
    "Use uma lista de 'estacionamento' para anotar pensamentos e tarefas que surgem sem abandonar a atividade principal.",
    "Escolha uma meta de processo ('resolver 6 questões') em vez de apenas uma meta de tempo ('ficar 1 hora sentado').",
    "Ambientes com longos prazos, liberdade excessiva e distrações podem favorecer procrastinação; ajuste o ambiente, não apenas a força de vontade.",
    "Pausas devem recuperar atenção, não transformar cinco minutos em uma sequência imprevisível de distrações.",
  ...
  sections: [
    ...
    {
      "title": "Reduza atrito para começar",
      "paragraphs": [
        "Reduza atrito para começar: material aberto, tarefa definida e primeiro passo pequeno."
      ],
      "id": "reduza-atrito-para-comecar"
    },
    {
      "title": "Afaste notificações e estímulos que disputam atenção durante blocos de es…",
      "paragraphs": [
        "Afaste notificações e estímulos que disputam atenção durante blocos de estudo."
      ],
      "id": "afaste-notificacoes-e-estimulos-que-disputam-atencao-durante-blocos-de-es"
    },
    {
      "title": "Use uma lista de 'estacionamento' para anotar pensamentos e tarefas que s…",
      "paragraphs": [
        "Use uma lista de 'estacionamento' para anotar pensamentos e tarefas que surgem sem abandonar a atividade principal."
      ],
      "id": "use-uma-lista-de-estacionamento-para-anotar-pensamentos-e-tarefas-que-s"
    },
    {
      "title": "Escolha uma meta de processo ('resolver 6 questões') em vez de apenas uma…",
      "paragraphs": [
        "Escolha uma meta de processo ('resolver 6 questões') em vez de apenas uma meta de tempo ('ficar 1 hora sentado')."
      ],
      "id": "escolha-uma-meta-de-processo-resolver-6-questoes-em-vez-de-apenas-uma"
    },
    {
      "title": "Ambientes com longos prazos, liberdade excessiva e distrações podem favor…",
      "paragraphs": [
        "Ambientes com longos prazos, liberdade excessiva e distrações podem favorecer procrastinação; ajuste o ambiente, não apenas a força de vontade."
      ],
      "id": "ambientes-com-longos-prazos-liberdade-excessiva-e-distracoes-podem-favor"
    },
    {
      "title": "Pausas devem recuperar atenção, não transformar cinco minutos em uma sequ…",
      "paragraphs": [
        "Pausas devem recuperar atenção, não transformar cinco minutos em uma sequência imprevisível de distrações."
      ],
      "id": "pausas-devem-recuperar-atencao-nao-transformar-cinco-minutos-em-uma-sequ"
    },
    {
      "title": "Cenários e exemplos desenvolvidos",
      "paragraphs": [],
      "examples": [
        "Cenário escolar: um estudante tem duas provas e um trabalho na mesma semana. Em vez de estudar tudo de forma genérica, aplica o princípio de foco-e-concentracao-como-reduzir-distracoes para transformar a situação em decisões concretas.",
    ...
    },
    {
      ...
      "paragraphs": [
        "Missão: aplique o princípio de Foco e concentração: como reduzir distrações a uma situação real desta semana."
      ],
    ...
    },
    {
      ...
      "paragraphs": [
        "Escolha uma situação real relacionada a Foco e concentração: como reduzir distrações. Escreva como agiria espontaneamente. Depois refaça a decisão usando um critério do guia e defina uma evidência que mostraria se a nova abordagem ajudou."
      ],
      "examples": [
  ...
  relatedGuides: [
    ...
    "metas-de-estudo-como-definir-objetivos-que-fazem-sentido"
  ],
