...
export const metasDeEstudoComoDefinirObjetivosQueFazemSentidoGuide = {
  slug: "metas-de-estudo-como-definir-objetivos-que-fazem-sentido",
  category: "estudar",
  title: "Metas de estudo: como definir objetivos que fazem sentido",
  summary: "Criar metas específicas, pequenas e ajustáveis, evitando metas vagas ou irreais.",
  description: "Criar metas específicas, pequenas e ajustáveis, evitando metas vagas ou irreais. Este guia deve ser lido como orientação educativa e prática, não como uma fórmula única. A proposta da Rumo é ajudar o estudante a compreender o tema, tomar decisões mais informadas e transformar a leitura em uma próxima ação concreta.",
  readTime: 8,
  tags: [
    "metas",
    "estudo",
  ...
  learningObjectives: [
    "Metas úteis descrevem comportamento verificável e um critério de conclusão.",
    "Quebre metas de resultado ('subir minha nota') em metas de processo ('resolver três listas e corrigir erros').",
    "Use horizonte curto para execução e horizonte maior para direção.",
    "Revise metas quando novas informações aparecem; ajuste não é fracasso, é gestão.",
    "Evite acumular muitas metas simultâneas, pois isso dilui prioridade e aumenta troca de contexto.",
    "Defina o próximo passo antes de encerrar uma sessão de estudo.",
  ...
  sections: [
    ...
    {
      "title": "Metas úteis descrevem comportamento verificável e um critério de conclusão",
      "paragraphs": [
        "Metas úteis descrevem comportamento verificável e um critério de conclusão."
      ],
      "id": "metas-uteis-descrevem-comportamento-verificavel-e-um-criterio-de-conclusao"
    },
    {
      "title": "Quebre metas de resultado ('subir minha nota') em metas de processo ('res…",
      "paragraphs": [
        "Quebre metas de resultado ('subir minha nota') em metas de processo ('resolver três listas e corrigir erros')."
      ],
      "id": "quebre-metas-de-resultado-subir-minha-nota-em-metas-de-processo-res"
    },
    {
      "title": "Use horizonte curto para execução e horizonte maior para direção",
      "paragraphs": [
        "Use horizonte curto para execução e horizonte maior para direção."
      ],
      "id": "use-horizonte-curto-para-execucao-e-horizonte-maior-para-direcao"
    },
    {
      "title": "Revise metas quando novas informações aparecem; ajuste não é fracasso, é…",
      "paragraphs": [
        "Revise metas quando novas informações aparecem; ajuste não é fracasso, é gestão."
      ],
      "id": "revise-metas-quando-novas-informacoes-aparecem-ajuste-nao-e-fracasso-e"
    },
    {
      "title": "Evite acumular muitas metas simultâneas, pois isso dilui prioridade e aum…",
      "paragraphs": [
        "Evite acumular muitas metas simultâneas, pois isso dilui prioridade e aumenta troca de contexto."
      ],
      "id": "evite-acumular-muitas-metas-simultaneas-pois-isso-dilui-prioridade-e-aum"
    },
    {
      "title": "Defina o próximo passo antes de encerrar uma sessão de estudo",
      "paragraphs": [
        "Defina o próximo passo antes de encerrar uma sessão de estudo."
      ],
      "id": "defina-o-proximo-passo-antes-de-encerrar-uma-sessao-de-estudo"
    },
    {
      "title": "Cenários e exemplos desenvolvidos",
      "paragraphs": [],
      "examples": [
        "Cenário escolar: um estudante tem duas provas e um trabalho na mesma semana. Em vez de estudar tudo de forma genérica, aplica o princípio de metas-de-estudo-como-definir-objetivos-que-fazem-sentido para transformar a situação em decisões concretas.",
    ...
    },
    {
      ...
      "paragraphs": [
        "Missão: aplique o princípio de Metas de estudo: como definir objetivos que fazem sentido a uma situação real desta semana."
      ],
    ...
    },
    {
      ...
      "paragraphs": [
        "Escolha uma situação real relacionada a Metas de estudo: como definir objetivos que fazem sentido. Escreva como agiria espontaneamente. Depois refaça a decisão usando um critério do guia e defina uma evidência que mostraria se a nova abordagem ajudou."
      ],
      "examples": [
  ...
  relatedGuides: [
    "gestao-do-tempo-para-estudantes",
