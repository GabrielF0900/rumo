...
export const comoSaberSeQueroMesmoFazerFaculdadeGuide = {
  ...
  learningObjectives: [
    "Faculdade é um caminho, não uma obrigação universal.",
    "Liste o que você espera obter: formação, profissão regulamentada, pesquisa, rede, experiência ou outro objetivo.",
    "Compare alternativas como técnico, trabalho, cursos livres, preparação específica ou pausa planejada.",
    "Pesquise requisitos reais das áreas de interesse.",
    "Evite decidir apenas por pressão social ou medo.",
    "Se possível, teste interesse com cursos introdutórios, projetos e conversas antes de comprometer anos.",
  ...
  sections: [
    ...
    {
      "title": "Faculdade é um caminho, não uma obrigação universal",
      "paragraphs": [
        "Faculdade é um caminho, não uma obrigação universal."
      ],
      "id": "faculdade-e-um-caminho-nao-uma-obrigacao-universal"
    },
    {
      "title": "Liste o que você espera obter",
      "paragraphs": [
        "Liste o que você espera obter: formação, profissão regulamentada, pesquisa, rede, experiência ou outro objetivo."
      ],
      "id": "liste-o-que-voce-espera-obter"
    },
    {
      "title": "Compare alternativas como técnico, trabalho, cursos livres, preparação es…",
      "paragraphs": [
        "Compare alternativas como técnico, trabalho, cursos livres, preparação específica ou pausa planejada."
      ],
      "id": "compare-alternativas-como-tecnico-trabalho-cursos-livres-preparacao-es"
    },
    {
      "title": "Pesquise requisitos reais das áreas de interesse",
      "paragraphs": [
        "Pesquise requisitos reais das áreas de interesse."
      ],
      "id": "pesquise-requisitos-reais-das-areas-de-interesse"
    },
    {
      "title": "Evite decidir apenas por pressão social ou medo",
      "paragraphs": [
        "Evite decidir apenas por pressão social ou medo."
      ],
      "id": "evite-decidir-apenas-por-pressao-social-ou-medo"
    },
    {
      "title": "Se possível, teste interesse com cursos introdutórios, projetos e convers…",
      "paragraphs": [
        "Se possível, teste interesse com cursos introdutórios, projetos e conversas antes de comprometer anos."
      ],
      "id": "se-possivel-teste-interesse-com-cursos-introdutorios-projetos-e-convers"
    },
    {
    ...
    },
    {
      ...
      "paragraphs": [
        "Missão: aplique o princípio de Como saber se quero mesmo fazer faculdade a uma situação real desta semana."
      ],
    ...
    },
    {
      ...
      "paragraphs": [
        "Escolha uma situação real relacionada a Como saber se quero mesmo fazer faculdade. Escreva como agiria espontaneamente. Depois refaça a decisão usando um critério do guia e defina uma evidência que mostraria se a nova abordagem ajudou."
      ],
      "examples": [
  ...
  relatedGuides: [
    "como-aproveitar-oportunidades-dentro-da-universidade",
